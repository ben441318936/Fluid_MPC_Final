...
z = np.linspace(0.5, 7.5-1, 7*FACTOR)
print(z)
print(len(emit_pos))
for p in z:
...
x = np.linspace(0.5, 9.5-1, 9*FACTOR)
print(x)
print(len(emit_pos))
for p in x:
...
z = np.linspace(0.5, 2.9-0.8, 3*FACTOR)
print(z)
print(len(emit_pos))
for p in z:
...
x = np.linspace(0.5, 6.5-1, 6*FACTOR)
print(x)
print(len(emit_pos))
for p in x:
...
z = np.linspace(2.9, 5.3-0.8, 3*FACTOR)
print(z)
print(len(emit_pos))
for p in z:
...
z = np.linspace(5.3, 7.7-0.8, 3*FACTOR)
print(z)
print(len(emit_pos))
for p in z:
...
print("Final number of emission points: ",emit_pos.shape[0])
